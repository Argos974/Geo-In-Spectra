...
export const PARCOURS: Parcours[] = [
  {
    ...
    steps: [
      ...
      "L'Atelier, séance 10 (commenter un document cartographique) : la seule séance qui fait lire et critiquer un document plutôt que d'en produire un",
    ],
    stops: [
      ...
      { label: "L'Atelier, séance 10", to: "/module/travaux-pratiques" },
    ],
  },
  {
    id: "licence-but-sig",
    ...
    steps: [
      ...
      "Après Le Compas également : séance 11 de l'Atelier (auditer la qualité d'un jeu de données), une compétence professionnelle directe pour un BUT",
    ...
    stops: [
      ...
      { label: "L'Atelier, séances 4, 11", to: "/module/travaux-pratiques" },
  ...
  },
  {
    ...
    steps: [
      ...
      "L'Atelier, séance 12 : valider statistiquement une classification (test de McNemar), sur les résultats réels de la séance 6",
    ],
    stops: [
      ...
      { label: "L'Atelier, séance 12", to: "/module/travaux-pratiques" },
    ],
  },
]
